...
class Net(nn.Module):
    '''
    torch.nn.Module is the super class, which is the base class for all neural networks modules.
    '''
    def __init__(self, params):
        ...
        '''
        #The super funcation will call the init function from nn.Module
        ...
        # the softplus function output positive numbers, which is a smooth approximation of the ReLU function.
